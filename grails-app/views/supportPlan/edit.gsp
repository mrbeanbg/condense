...
<html>
	...
	<body>
		<div class="container">
			...
			<div id="edit-supportPlan" class="content scaffold-edit" role="main">
				...
				<g:form url="[resource:supportPlanInstance, action:'update']" class="form-horizontal" method="PUT" >
					<g:hiddenField name="version" value="${supportPlanInstance?.version}" />
					<fieldset class="form">
